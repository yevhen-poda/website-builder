...
export class AbstractElementComponent extends AbstractComponent {
  ...
  _afterCreateElement() {
    switch (this._data.type) {
      ...
      case ElementType.P:
        this.getElement()
          .querySelector('.content-element')
          .addEventListener('blur', this._contentBlurHandler)
        this.getElement()
          .querySelector('.content-element')
          .addEventListener('keydown', this._contentKeyDownHandler)
        break
      case ElementType.IMG:
        this.getElement()
          .querySelector('.img-upload__label')
          .addEventListener('click', this._contentClickHandler)
        break
    }

    this.getElement()
      .querySelector('button.delete-btn')
      .addEventListener('click', this._deleteBtnClickHandler)
  }
